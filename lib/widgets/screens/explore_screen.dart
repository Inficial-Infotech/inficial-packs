...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  void callback(int segmentedControlValue) {
    ...
    if (segmentedControlValue == 4 &&
        draggableScrollableController.size <= 0.8) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(CupertinoIcons.back, color: PXColor.darkText),
                        Expanded(
                            child: Container(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(
                              viewPort > 350 ? 0 : PXBorderRadius.radiusL),
                        ...
                        child: segmentedControlValue == 4
                            ? Padding(
                                padding:
                                    const EdgeInsets.all(PXSpacing.spacingM),
                                child: _dealModels.isNotEmpty
                                    ? ListView.builder(
                                        controller: scrollController,
                                        itemCount: _dealModels.length,
                                        itemBuilder: (context, index) {
                                          return MateDetailCard(
                                            image:
                                                _dealModels[index].titleImage,
                                            age: '29',
                                            gender: 'Male',
                                            name: 'John smith',
                                          );
                      ...
                      AnimatedContainer(
                        margin: EdgeInsets.only(
                          top: viewPort > 350 ? 0 : 30,
                        ),
                        height: viewPort > 350 ? 0 : 50,
                        alignment: Alignment.topCenter,
                        duration: const Duration(milliseconds: 200),
                        child: const Text('Island hopping, 8',
